...
// export const YOUTUBE_API_KEY: string = 'YOUR_YOUTUBE_API_KEY'; // Removed as per request
...
export const MOCK_VIDEOS = [
  // Removed all YouTube videos from initial mock data
  {
    ...
    thumbnail: 'https://picsum.photos/320/180?random=vimeo_nature',
    duration: 240,
    source: 'vimeo',
    url: 'https://vimeo.com/76979871', // Example Vimeo ID
    views: 100,
...
export const MOCK_APP_SETTINGS = {
  ...
  privacyPolicyUrl: '#',
  termsOfServiceUrl: '#',
  // youtubeApiKey: YOUTUBE_API_KEY, // Removed
